...
| **[Production mix](production_mix/)** | allocate plant capacity across 10 products — margin / throughput / sustainability *(purely linear)*, 30% cap + ≤2 SKUs/line — the **richer exact-LP duals** showcase (swing SKU, structural exclusions) | [problem.json](production_mix/problem.json) · [scores.json](production_mix/scores.json) |
